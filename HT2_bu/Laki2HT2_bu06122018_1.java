...
public class Laki2HT2{
    ...
    //Looks up and prints the ASCII info of a param int array
    public static void printInfo(int[][] parArray){
        //Size of the param array
        int rows = parArray.length;
        int cols = parArray[0].length;

        //Counters for the ASCII chars
        int count1 = 0;
        
        //Convert the param array into char array
        char[][] charArray = integersToCharacters(parArray);
