...
them as either ASCII graphics or numbers. User is able to filter
...
public class LakiHT2{
    ...
    public static void main(String[] args){
        ...
        if(args.length == 1){
            ...
            //Proceed only if valid char array returned, otherwise invalid CLP
            if(cArray != null){
                //Convert to iArray
                ...
                while(!quit){
                    ...
                    //Loads the int array from file again
                        ...
                        iArray = charactersToIntegers(cArray);
                    }
                    //Quit program
    ...
    //Loads CLP text file's contents into char array
    //Returns char array or null if exception or param file without size
    ...
    //Returns filtered array or null if null param array
    ...
    //Returns copied int array or null if null param
